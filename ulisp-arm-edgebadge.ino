...
//  GFXBuffer_t tft = GFXBuffer_t(80, 160, display_t(44, 45, 41, 42, 46));
  Adafruit_ST7735 tft = Adafruit_ST7735(44, 45, 41, 42, 46);
  #include <Adafruit_NeoPixel.h>
  #define LIGHT_SENSOR A7
  #define NEOPIXELS_PIN 8
  #define NEOPIXELS_COUNT 5
  Adafruit_NeoPixel neopixels(NEOPIXELS_COUNT, NEOPIXELS_PIN, NEO_GRB + NEO_KHZ800);
  #endif
